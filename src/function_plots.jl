...
# Plot of map with b = 1.5
b_one_and_half_plot = Figure(fontsize = 16)
ax = Axis(b_one_and_half_plot[1, 1], xlabel = L"ϕ_{i}", ylabel = L"ϕ_{i+1}",
          xlabelsize = 24, ylabelsize = 24)
...
lines!(ax, xs, ys, linewidth = 2, color = :black, linestyle = :dash)
b_one_plot
save("plots/b_one_and_half_plot.png", b_one_and_half_plot)
